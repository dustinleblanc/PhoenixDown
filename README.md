...
[![Travis CI](https://travis-ci.org/dustinleblanc/PhoenixDown.svg?branch=master)](https://travis-ci.org/dustinleblanc/PhoenixDown)
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/dustinleblanc/PhoenixDown)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/dustinleblanc/PhoenixDown/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/dustinleblanc/PhoenixDown/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/dustinleblanc/PhoenixDown/badge.svg?branch=master)](https://coveralls.io/github/dustinleblanc/PhoenixDown?branch=master) 
...
[![License](https://poser.pugx.org/dustinleblanc/PhoenixDown/license)](https://github.com/dustinleblanc/PhoenixDown//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/dustinleblanc/PhoenixDown)
| Linux permutation testing | [DONE](https://travis-ci.org/dustinleblanc/PhoenixDown)
...
deploy:
  ...
  on:
    tags: true
    repo: dustinleblanc/PhoenixDown
```
...
- [GitHub issue templates](https://github.com/dustinleblanc/PhoenixDown/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/dustinleblanc/PhoenixDown/releases) page.

## Authors

* **Dustin LeBlanc** - created project from template.

See also the list of [contributors](https://github.com/dustinleblanc/PhoenixDown/contributors) who participated in this project.
